...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let showPrecioTotal = document.getElementById("showPrecioTotal");

  showButton.addEventListener("click", showList);
  precioTotal.addEventListener("click", calcularprecioTotal);

  function showList() {
    autos.map((coche) => {
      const newDiv = document.createElement("div");
      newDiv.textContent = `Marca: ${coche.marca} Precio: ${coche.precio}`;
  ...
  function calcularprecioTotal() {
    ...
    showPrecioTotal.textContent = precio;
  }
});
